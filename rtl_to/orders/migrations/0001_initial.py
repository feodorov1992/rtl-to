# Generated by Django 4.0.2 on 2022-05-11 09:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_addr_forlist', models.CharField(editable=False, max_length=255, verbose_name='Адрес отправления')),
                ...
                ('from_date_plan', models.DateField(blank=True, null=True, verbose_name='Плановая дата отправки')),
                ('from_date_fact', models.DateField(blank=True, null=True, verbose_name='Фактическая дата отправки')),
