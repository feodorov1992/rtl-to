# Generated by Django 4.0.8 on 2022-10-25 12:26
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('print_forms', '0005_alter_waybilldata_ext_order'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='waybill_date',
            field=models.DateField(default=datetime.datetime(2022, 10, 25, 12, 26, 56, 868477), verbose_name='Дата накладной'),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='waybilldata',
            name='waybill_number',
            field=models.CharField(max_length=100, unique=True, verbose_name='Номер ТН'),
        ),
